...
##  
## Propósito del Script: Realizar simulaciones para CLCR = 120 mL/min
##  
...
outexposure <- '041_exp_CLCR120_'
outputfile  <- '042_out_CLCR120_'
...
# Carga de parámetros del modelo (120 mL/min)
