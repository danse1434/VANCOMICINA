...
##  
## Propósito del Script: Realizar simulaciones para CLCR = 150 mL/min
##  
...
outexposure <- '061_exp_CLCR150_'
outputfile  <- '062_out_CLCR150_'
...
# Carga de parámetros del modelo (150 mL/min)
