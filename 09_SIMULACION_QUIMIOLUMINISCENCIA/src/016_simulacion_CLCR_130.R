...
##  
## Propósito del Script: Realizar simulaciones para CLCR = 130 mL/min
##  
...
outexposure <- '051_exp_CLCR130_'
outputfile  <- '052_out_CLCR130_'
...
# Carga de parámetros del modelo (130 mL/min)
