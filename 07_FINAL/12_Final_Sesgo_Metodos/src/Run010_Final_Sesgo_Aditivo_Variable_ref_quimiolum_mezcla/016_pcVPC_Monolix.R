...
# 1. Lectura de datos -----------------------------------------------------
#-------------------------------------------------------------------------------#
model_name <- "Run010_Final_Sesgo_Aditivo_Variable_ref_quimiolum_mezcla"
source(file.path('src', model_name, '052_fun_pcVPC.R'), encoding = 'UTF-8')
project_dir <- file.path('.', model_name)
...
ggsave(file.path(project_dir, 'figures', paste0(model_name, '016_pcVPC_IC.pdf')), vpcTipo, 'pdf',
       width = 6, height = 3.5)
