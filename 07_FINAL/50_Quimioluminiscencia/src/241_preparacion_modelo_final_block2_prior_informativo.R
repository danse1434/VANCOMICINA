...
#' 
#' Parámetros iniciales basados en run200 de esquema de modelamiento
#' 
hiperparametros <- list(
  ...
  mu_Omega = c(0.22,  0.22),
  sd_Omega = c(0.042, 0.055),
...
init <- function() {
  ...
  omega_Q <- rnorm(1, hp$mu_Omega_Q, hp$sd_Omega_Q)
