...
modelName <- '225_modelo_final_full_prior_informativo'
run_file <- "run200"
...
df_out["Parameter"] <- c("CL (L/h)", "Q (L/h)", "V1 (L)", "V2 (L)",
                         ...
                         "Omega Q (CV%)", "Omega V2 (CV%)",
                         "rho (CL,V1)", "rho (CL,Q)", "rho (CL,V2)",
                         "rho (V1,Q)", "rho (v1,V2)", "rho (Q,V2)",
                         "b (%)")
...
gt_out <- gt(df_out) %>% 
  ...
  tab_header(title = "Modelo bayesiano - Run 225", 
