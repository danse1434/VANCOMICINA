...
transformed parameters{
  ...
  logtheta = rep_matrix(log(thetaHat), nSubjects1) + diag_pre_multiply(omega, rho1 * logtheta_raw);
  
  theta = (rep_matrix(thetaHat, nSubjects) .* exp(diag_pre_multiply(omega, L * eta)))';
