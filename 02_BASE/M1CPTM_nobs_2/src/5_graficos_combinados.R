...
# Apertura de fuente
source(file.path('src', '11_fun_graficos_combinados.R'), encoding = 'UTF-8')
source(file.path('src', '10_performance_fun.R'), encoding = 'UTF-8')

# Definición Carpetas
homedir <- file.path('M1CPTM_nobs_2', 'M1CPTM_nobs_2')
...
ggsave(file.path(homedir, 'figures', '001_y_G_GOF.pdf'), G1, 
       device = 'pdf', width = 8, height = 3.6, units = 'in')  
