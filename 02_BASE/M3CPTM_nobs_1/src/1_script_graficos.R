...
# Apertura de fuente
source(file.path('src', '10_peformance_fun.R'), encoding = 'UTF-8')
source("M3CPTM_nobs_1/src/2_funciones.R", encoding = 'UTF-8')
...
auxdir <- file.path('M3CPTM_nobs_1', 'm3cptm_nobs1')
