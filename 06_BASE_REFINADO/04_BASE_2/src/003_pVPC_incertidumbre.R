...
## mediante simulación por medio del paquete MlxR con incertidumbre en parámetros 
## poblacionales obtenida por el algoritmo Stan 
##  
...
# Crear un vector con parámetros e hiperparámetros
param1 <- append(param, hiperPar1)
