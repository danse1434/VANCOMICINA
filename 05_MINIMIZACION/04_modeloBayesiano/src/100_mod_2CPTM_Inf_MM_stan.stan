...
functions{
  ...
  * dosificación.
  * 
  * @param amt contiene el historial de administración en forma de matriz
  * en la primera columna debe contener los tiempos de dosificación, en la 
  * segunda columna debe contener la dosis o cantidad administrada (p.ej. mg),
  * en la tercera columna debe contener el tiempo de infusión de esa dosis.
  * 
  *
  */
