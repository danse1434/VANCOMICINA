...
ggsave(filename = file.path(auxdir, 'figures', 'M1_pcVPC_percentil.pdf'), 
       g_percs1, 
...
#-------------------------------------------------------------------------------#
# Almacenar RDS
saveRDS(g_percs,  file.path(auxdir, 'figures', 'RDS', 'M1_VPC_percentil.rds'))
saveRDS(g_percs1, file.path(auxdir, 'figures', 'RDS', 'M1_pcVPC_percentil.rds'))
