...
# Apertura de fuente
source(file.path('src', '012_performance_fun.R'), encoding = 'UTF-8')
source(file.path('src', '013_fun_graficos_combinados.R'), encoding = 'UTF-8')

# Definición Carpetas
homedir <- file.path('M2CPTM_nobs_2_aditv', 'M2CPTM_nobs_2_aditv')
